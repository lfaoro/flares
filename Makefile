...
docker:
	docker build -t ghcr.io/lfaoro/flares:$(VERSION) -t ghcr.io/lfaoro/flares:latest .
	docker push ghcr.io/lfaoro/flares:$(VERSION)
	docker push ghcr.io/lfaoro/flares:latest
